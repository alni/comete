...
public class FGFSConnection1 {
	 ...
	 */
	public FGFSConnection1(String host, int port) throws IOException {
		setHost(host);
		setPort(port);
	 ...
	 * 
	 * @param name
	 *            The Comete property name to look up.
	 * @return The property value as a string (non-existant properties return
	 *         the empty string).
	 * @exception IOException
	 *                If there is an error communicating with Comete or if
	 ...
	 * 
	 * @param name
	 *            The Comete property name to modify or create.
	 * @param value
