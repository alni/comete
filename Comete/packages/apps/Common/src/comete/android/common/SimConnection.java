...
/**
 * A connection to a running instance of a Simulator.
 * 
 * <p>
 * This class currently uses a Generic socket connection of the Simulator FlightGear telnet interface, though it may be
...
public class SimConnection {
	 ...
	 */
	public SimConnection(String host, int port) throws IOException {
		setHost(host);
		setPort(port);
